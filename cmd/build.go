...
import (
	...
	"code.byted.org/lark_search/larksuite-cli/cmd/completion"
	cmdconfig "code.byted.org/lark_search/larksuite-cli/cmd/config"
	"code.byted.org/lark_search/larksuite-cli/cmd/doctor"
	cmdevent "code.byted.org/lark_search/larksuite-cli/cmd/event"
	"code.byted.org/lark_search/larksuite-cli/cmd/profile"
	"code.byted.org/lark_search/larksuite-cli/cmd/schema"
	"code.byted.org/lark_search/larksuite-cli/cmd/service"
	"code.byted.org/lark_search/larksuite-cli/cmd/skill"
	cmdupdate "code.byted.org/lark_search/larksuite-cli/cmd/update"
